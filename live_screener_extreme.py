...
async def send_telegram_notification(message: str) -> bool:
    """Sends HTML notification to configured Telegram channel using resilient client."""
    from telegram_client import send_telegram_alert
    return await send_telegram_alert(message, bot_token=TELEGRAM_BOT_TOKEN, chat_id=TELEGRAM_CHAT_ID)
